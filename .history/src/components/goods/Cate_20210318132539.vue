    ...
    <el-dialog
      ...
      <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
        ...
        <el-form-item label="父级分类：">
          <!-- options用来指定数据源 -->
          <!-- props用来指定配置对象 -->
          <el-cascader clearable @change="parentCateChanged" expand-trigger="hover" :options="parentCateList" :props="cascaderProps" v-model="selectedKeys">
      ...
      <span slot="footer">
        ...
        <el-button @click="addCateDialogVisiblee=false">取消</el-button>
      </span>
    </el-dialog>
   </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      addCateFormRules: {
        cat_name: [
          { required: trie, message: '请输入分类名称', trigger: 'blur' }
        ]
      },
      // 父级分类的列表
      parentCateList: [],
